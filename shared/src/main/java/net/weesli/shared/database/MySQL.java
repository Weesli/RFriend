...
public class MySQL implements Database {
    ...
    private String host = RFriend.getInstance().getConfig().getString("options.database.host");
    private int port = RFriend.getInstance().getConfig().getInt("options.database.port");
    private String database = RFriend.getInstance().getConfig().getString("options.database.database");
    private String username = RFriend.getInstance().getConfig().getString("options.database.username");
    private String password = RFriend.getInstance().getConfig().getString("options.database.password");

    public MySQL(){
        builder =new MySQLBuilder(host,port,database,username,password);
